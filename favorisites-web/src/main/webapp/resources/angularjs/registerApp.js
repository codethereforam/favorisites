    ...
    registerApp.controller('formController', ['$scope', '$http', '$interval', function ($scope, $http, $interval) {
        ...
        $scope.register = function () {
            $http({
                ...
                url: '/users',
                data: {
                    "confirmedPassword": $scope.user.cpasswordValue,
                    "email":$scope.user.emailValue ,
                    "emailCaptcha": $scope.user.codeValue,
                    "password": $scope.user.passwordValue,
                    "sex":$scope.user.sexValue ,
                    "username": $scope.user.usernameValue
                }
            }).then(function successCallback(response) {
